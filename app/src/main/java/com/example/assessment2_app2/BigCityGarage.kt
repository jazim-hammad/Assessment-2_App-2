...
class BigCityGarage : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        supportActionBar?.hide() //Disables the bar at the top of the app.
        setContentView(R.layout.activity_big_city_garage)
        button_link.setOnClickListener{
            val i = Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/maps/KpYuWGUW8EDw3gbE8"))
            startActivity(i)
        }
    }
}